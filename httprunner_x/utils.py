...
from httprunner_x import exceptions, logger, __version__
from httprunner_x.compat import basestring, bytes, is_py2
...
def init_sentry_sdk():
    sentry_sdk.init(
        dsn="https://78d9d0584d3c4f308b09845032370497@sentry.io/1893931",
        release="httprunner_x@{}".format(__version__)
    )
