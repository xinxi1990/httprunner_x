...
from httprunner_x import exceptions, utils, loader
from httprunner_x.compat import basestring, numeric_types, str
...
def get_mapping_function(function_name, functions_mapping):
    ...
    if function_name in functions_mapping:
        ...
        from httprunner_x.ext import uploader
    ...
    for test_dict in tests:
        ...
        if "request" in test_dict:
            ...
            if "upload" in test_dict["request"]:
                from httprunner_x.ext.uploader import prepare_upload_test
